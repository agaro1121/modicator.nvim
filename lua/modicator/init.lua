...
--- @field foreground? 'bg' | 'fg' Whether to use the highlight's foreground or background
--- @field background? 'bg' | 'fg' Whether to use the highlight's foreground or background
...
M.set_cursor_line_highlight = function(hl_name)
  ...
  hl = vim.tbl_extend('keep', { bg = hl.fg, fg = hl.bg }, hl)
